...
exts = []
exts = (exts.concat MAPPINGS[type] for type in MAPPINGS)

dirs = (key for key in IGNORE_DIRS)


PATTERN_EXT = exts.join ','

PATTERN_DIR  = escapeRegExp dirs.join "|";
PATTERN_EDIR = " --exclude-dir=#{dirs.join ' --exclude-dir='}"
