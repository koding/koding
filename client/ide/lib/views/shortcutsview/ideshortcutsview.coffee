...
module.exports = class IDEShortcutsView extends KDCustomScrollView
  ...
  getShortcuts: ->
    ...
    # FIXME
    # get these from KD.appClasses.IDEoptions.keyBindings
    ...
    'Workspace Shortcuts':
      ...
      'Go to tab number 1'     : 'Ctrl-Shift-1'
      'Go to tab number 2'     : 'Ctrl-Shift-2'
      'Go to tab number 3'     : 'Ctrl-Shift-3'
      'Go to tab number 4'     : 'Ctrl-Shift-4'
      'Go to tab number 5'     : 'Ctrl-Shift-5'
      'Go to tab number 6'     : 'Ctrl-Shift-6'
      'Go to tab number 7'     : 'Ctrl-Shift-7'
      'Go to tab number 8'     : 'Ctrl-Shift-8'
      'Go to tab number 9'     : 'Ctrl-Shift-9'
