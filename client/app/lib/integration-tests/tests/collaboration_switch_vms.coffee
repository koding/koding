...
describe "collaboration_switch_vms.rfml", ->
  before -> 
    require './ide_switch_vms.coffee'
  ...
  describe """Return the first browser and click on 'aws-instance-1' labels on the left sidebar""", ->
    ...
    it """Do you see 'START COLLABORATION' in the bottom status bar?""", -> 
      assert(false, 'Not Implemented')
      #assertion here

    it """Do you see files are located under correct VMs??""", -> 
      assert(false, 'Not Implemented')
      #assertion here
