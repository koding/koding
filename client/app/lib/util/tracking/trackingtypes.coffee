module.exports = {
  # ACTIONS
  BUTTON_CLICKED  : 'clicked a button'
  MODAL_DISPLAYED : 'displayed a modal'

  PLAN_SELECTED   : 'selected a plan'
  PLAN_UPGRADED   : 'upgraded plan subscription'
  PLAN_DOWNGRADED : 'downgraded plan subscription'

  BILLING_CYCLE_CHANGED : 'changed billing cycle'
  ...
  STACKS_STARTED_EDIT         : 'started editing stack'
