class Payment_PurchaseHistory extends Payment_TabContent
  ...
  viewAppended:->
    ...
    left.addSubView purchaseList  = new Payment_OverviewHistoryList delegate : @, subItemClass : Payment_OverviewPurchaseHistoryListItem,@dummyPurchaseHistory
    right.addSubView new KDHeaderView type : "small", title : "Deposit History:"
    right.addSubView depositList  = new Payment_OverviewHistoryList delegate : @, subItemClass : Payment_OverviewDepositHistoryListItem,@dummyDepositHistory
