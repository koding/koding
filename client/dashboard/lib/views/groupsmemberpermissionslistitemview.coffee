...
KDView = kd.View
GroupsMemberRolesEditView = require './groupsmemberroleseditview'
...
module.exports = class GroupsMemberPermissionsListItemView extends KDListItemView
  ...
  constructor: (options = {}, data) ->
    ...
    if 'owner' in @usersRole or whoami().getId() is data.getId()
  ...
  showEditMemberRolesView: ->
    ...
    @editView      = new GroupsMemberRolesEditView { delegate : this }
