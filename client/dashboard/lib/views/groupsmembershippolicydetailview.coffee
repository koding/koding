...
GroupsEditableWebhookView = require './groupseditablewebhookview'
GroupsFormGeneratorView = require '../groupsformgeneratorview'
GroupsMembershipPolicyLanguageEditor = require './groupsmembershippolicylanguageeditor'
GroupsWebhookView = require './groupswebhookview'
KodingSwitch = require 'app/commonviews/kodingswitch'
JView = require 'app/jview'


module.exports = class GroupsMembershipPolicyDetailView extends JView
