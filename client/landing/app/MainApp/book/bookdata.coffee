__bookPages = [
  ...
  ,
    ...
    content   : """<p>Terminal is a very important aspect of development, that's why we have invested a lot of time to provide a fast, smooth and responsive console.</p>
                   <p>It's an Ubuntu VM that you can use to program Java,C++,Perl,Python,Ruby,Node,Erlang,Haskell and what not, out of the box. Other than being root, everything is possible. This VM is not a simulation, it is a real computer, and it's yours.</p>"""
  ,
    title     : "Apps"
