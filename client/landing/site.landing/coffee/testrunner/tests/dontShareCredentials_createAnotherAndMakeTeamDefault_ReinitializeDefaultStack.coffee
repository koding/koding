...
module.exports = ->
  ...
  describe 'dontShareCredentials_createAnotherAndMakeTeamDefault_ReinitializeDefaultStack', ->
    ...
    describe "Click on the 'NEXT' button ?", ->
      ...
      it "Do you see 'Select credential...' text in a textbox under 'AWS Credential:' section??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Click on the little arrows next to 'Select credential...' text?", ->
      ...
      it "Do you see 'RainforestQATeam2 AWS Keys' in the list??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Return to the first browser, close the modal by clicking (x) from top right and move your mouse over 'STACKS' title on left sidebar?", ->
      ...
      it "Do you see that (+) button appeared??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Click on (+) button, then select 'amazon web services' and click on 'CREATE STACK' button?", ->
      ...
      it "Do you see 'PREVIEW', 'LOGS', 'DELETE THIS STACK TEMPLATE' buttons on the bottom and 'SAVE' button on top right??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Click on 'MAKE TEAM DEFAULT', 'SHARE WITH THE TEAM' and 'YES' buttons respectively (if 'Stack Template is Updated' titled pop-up appears, click on 'OK')?", ->
      ...
      it "Has 'Reinitialize Default Stack' button appeared on top left sidebar??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Click on 'STACKS' from left sidebar?", ->
      ...
      it "Do you see '_Aws Stack' is moved to 'Drafts' section and 'Team Stack' is listed under 'Team Stacks' section??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Switch to the incognito window and close that modal by clicking (x) from top right?", ->
      ...
      it "Do you see the same 'Reinitialize Default Stack' button appeared on left sidebar??", (done) -> 
        assert(false, 'Not Implemented')
        done()
    ...
    describe "Click on 'STACKS' from left sidebar?", ->
      ...
      it "Do you see '_Aws Stack' is listed under 'Drafts' section and 'Team Stack' is listed under 'Team Stacks' section??", (done) -> 
        assert(false, 'Not Implemented')
        done()
