class OpenTokController extends KDController
   ...
   *
   * @return {OpenTokController} singleton instance of the class.
  ###
  @getInstance: do ->

    instance = null
    return -> instance or= new OpenTokController
   ...
   *
   * @emits OpenTokController#ClientLoaded
  ###
  initOpenTokClient: ->
   ...
   * @private
  ###
  generateChannelSession = (channel, callback = noop) ->
  ...
  ###
  getToken = (options, callback = noop) ->
  ...
  ###
  getChannelSession: (channel, callback = noop) ->
