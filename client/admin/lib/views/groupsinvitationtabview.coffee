...
KDView = kd.View
GroupsInvitationCodesTabPaneView = require '../groupsinvitationcodestabpaneview'
GroupsSentInvitationsTabPaneView = require '../groupssentinvitationstabpaneview'
KodingSwitch = require 'app/commonviews/kodingswitch'


module.exports = class GroupsInvitationTabView extends KDTabView
  ...
  addHeaderButtons:->
    ...
    @buttonContainer.addSubView @inviteByEmailButton = new KDButtonView
      ...
      cssClass : 'solid small green'
      testPath : "groups-admin-invite-button"
  ...
  # ,
    name         : 'Invitations'
    testPath     : "groups-admin-invitations"
    viewOptions  :
