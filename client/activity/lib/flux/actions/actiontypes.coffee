module.exports = {
  ...
  'SET_EMOJI_QUERY'
  'UNSET_EMOJI_QUERY'
  'SET_SELECTED_EMOJI_INDEX'
  'MOVE_TO_NEXT_EMOJI_INDEX'
  'MOVE_TO_PREV_EMOJI_INDEX'
  'CONFIRM_SELECTED_EMOJI_INDEX'
  'UNSET_SELECTED_EMOJI_INDEX'
  ...
  'COMPLETE_COMMON_EMOJI_LIST_SELECTION'
