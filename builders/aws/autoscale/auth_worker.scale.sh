CFG="as_authWorker_cfg_0.1.0" # Launch config name
PATH_TO_USER_DATA="../user-data/authworker-data.txt"
GRP="as_authWorker_grp" # Autoscale group name
SCALE_UP_POLICY="as_authWorker_policy" 
SCALE_DOWN_POLICY="as_authWorker_policy_scale_down"
