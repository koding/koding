...
module.exports = Broker = (function(_super) {
  ...
  function Broker(ws, options) {
    ...
    this.sockURL = ws;
    this.autoReconnect = options.autoReconnect, this.authChannelName = options.authChannelName, this.overlapDuration = options.overlapDuration, this.servicesEndpoint = options.servicesEndpoint;
  ...
  Broker.prototype.connect = function() {
    console.log({
      servicesEndpoint: this.servicesEndpoint
    });
