...
module.exports = Broker = (function(_super) {
  ...
  Broker.prototype.selectAndConnect = function(blacklist) {
    ...
    endPoint = !blacklist.length ? this.servicesEndpoint : "" + this.servicesEndpoint + "?all";
...
require.define("/node_modules_koding/koding-broker-client/node_modules/hat/package.json",function(require,module,exports,__dirname,__filename,process,global){module.exports = {"main":"index.js"}
});

require.define("/node_modules_koding/koding-broker-client/node_modules/hat/index.js",function(require,module,exports,__dirname,__filename,process,global){var hat = module.exports = function (bits, base) {
    if (!base) base = 16;
