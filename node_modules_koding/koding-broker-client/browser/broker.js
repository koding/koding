...
module.exports = Broker = (function(_super) {
  ...
  Broker.prototype.createChannel = function(name, _arg) {
    var channel, handler, isReadOnly, isSecret, routingKeyPrefix,
      _this = this;

    isReadOnly = _arg.isReadOnly, isSecret = _arg.isSecret;
    ...
    channel.on('setSecretName', function(secretName) {
      var secretChannel;

      isReadOnly = channel.isReadOnly;
      channel.setSecretName(secretName);
      secretChannel = _this.subscribe(secretName, {
        isReadOnly: isReadOnly,
        isSecret: true
      });
      secretChannel.setAuthenticationInfo({
        serviceType: 'secret'
      });
      return secretChannel.on('message', function() {
        var rest;
  ...
  Broker.prototype.subscribe = function(name, options, callback) {
    var handler, isReadOnly, isSecret, routingKeyPrefix,
      _this = this;
...
module.exports = Channel = (function(_super) {
  ...
  function Channel(name, routingKeyPrefix, _arg) {
    ...
    this.isReadOnly = _arg.isReadOnly, this.isSecret = _arg.isSecret;
  }
