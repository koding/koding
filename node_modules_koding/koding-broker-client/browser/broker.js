...
module.exports = Broker = (function(_super) {
  ...
  Broker.prototype.persisOldSocketId = function() {
    var clientId, oldSocket;
    oldSocket = this.socketId;
    clientId = $.cookie("clientId");
    if (clientId && oldSocket) {
      return $.cookie("oldSocket", "" + clientId + "@" + oldSocket);
    }
  };
  ...
  Broker.prototype.sendListenBrokerResubscriptions = function(socketId, failCallback) {
    var _this = this;
    if (!socketId) {
    ...
    return this.once('broker.resubscribed', function(found) {
      ...
      if (found) {
        ...
        return _this.persisOldSocketId();
      } else {
        return typeof failCallback === "function" ? failCallback() : void 0;
      }
    });
  ...
  Broker.prototype.tryToConnectWithOldSocketId = function(failCallback) {
    var clientId, oldSocket, socketId, _ref1,
      _this = this;
    if (oldSocket = $.cookie("oldSocket")) {
      _ref1 = oldSocket.split("@"), clientId = _ref1[0], socketId = _ref1[1];
      if (clientId = $.cookie("clientId") === clientId) {
        return this.sendListenBrokerResubscriptions(socketId, function() {
          return typeof failCallback === "function" ? failCallback() : void 0;
        });
      } else {
        $.cookie(oldSocketId, {
  ...
  Broker.prototype.resubscribeBySocketId = function() {
    var _this = this;
    return this.sendListenBrokerResubscriptions(this.socketId, function() {
      return _this.tryToConnectWithOldSocketId(_this.resubscribeBySubscriptions());
    });
  };
  ...
  Broker.prototype.resubscribe = function(callback) {
    var clientId, oldSocket, oldSocketId, socketId, _ref1;
    if (oldSocket = $.cookie("oldSocket")) {
      _ref1 = oldSocket.split("@"), clientId = _ref1[0], oldSocketId = _ref1[1];
    }
    socketId = this.socketId || oldSocketId;
    if ((this.socketId != null) || (oldSocketId != null)) {
...
require.define("/node_modules/koding-bound/lib/koding-bound/index.js",function(require,module,exports,__dirname,__filename,process,global){module.exports = function(method) {
  var boundMethod;
  if (this[method] == null) {
