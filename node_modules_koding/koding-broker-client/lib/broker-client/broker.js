...
module.exports = Broker = (function(_super) {
  ...
  Broker.prototype.wrapPrivateChannel = function(channel) {
    ...
    return channel.on('setSecretNames', function(_arg) {
      var publishingName, subscribingName;

      publishingName = _arg.publishingName, subscribingName = _arg.subscribingName;
  ...
  Broker.prototype.createChannel = function(name, options) {
    ...
    if (isExclusive || isPrivate || isP2P) {
