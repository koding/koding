  ...
  Broker.prototype.swapPrivateSourceChannel = function(channel) {
    ...
    if (channel.oldPrivateChannel != null) {
      return setTimeout(function() {
        var event, listener, _i, _len, _ref1, _ref2;

        channel.oldPrivateChannel.close().off();
        channel.privateChannel.pipe(channel);
        _ref1 = channel.eventRegister;
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          _ref2 = _ref1[_i], event = _ref2.event, listener = _ref2.listener;
  ...
  Broker.prototype.createChannel = function(name, _arg) {
    ...
    channel.on('newListener', function(event, listener) {
      ...
      if (channel.privateChannel != null) {
        return channel.trackListener(event, listener);
      } else if (event !== 'broker.subscribed') {
