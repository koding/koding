...
module.exports = class Broker extends `KDEventEmitter.Wildcard`
  ...
  resubscribeByOldSocketId: (failCallback)->
    oldSocket = @getConecctionData()
    if oldSocket
      {clientId, socketId} = oldSocket
      if @getClientId() is clientId
  ...
  getClientId: -> $.cookie "clientId"
  getConecctionData:-> localStorage.getItem "connectiondata"
  setConnectionData:-> localStorage.setItem "connectiondata", {clientId: @getClientId(), socketId: @socketId }
