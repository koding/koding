...
module.exports = class Subcollection
  ...
  constructor:(parent, children, annotation)->
    defineProperty @, 'parent_',             value: parent
    # avoid a(n explicit) circular dependency here:
    defineProperty @, 'parentConstructor_',  value: parent.constructor
    defineProperty @, 'annotation_',         value: annotation
    @push children...
  ###
  @method.
