...
module.exports = class Model extends Base
  ...
  @setClient = do ->
    ...
    setClientHelper = (constructor, client)->
      if constructor.client_?
    ...
    (overload, shouldConnect=yes)->
      ...
      if overload instanceof mongo.Db
        setClientHelper constructor, overload
        ...
        mongo.MongoClient.connect connStr, (err, db) =>
          ...
          setClientHelper constructor, db
          @emit 'dbClientReady'
        #mongo.db overload, safe: no
  ...
  @getCollection =->
    client = @getClient()
    unless client
      console.log __filename, process.pid
      throw new Error \
        """
