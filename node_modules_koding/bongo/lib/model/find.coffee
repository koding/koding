...
module.exports =
  ...
  remove:(selector, callback)->
    ...
    constructor = @
    collection = constructor.getCollection()
    try collection.remove castAll(selector, constructor), {safe:yes}, callback
    catch e then console.log selector; console.trace()
    @
  ...
  cursor:do->
    ...
    (selector, options, callback)->
      ...
      @someData selector, {}, options, (err, cursor)=>
        callback err, unless err then new ModelCursor cursor, @
  ...
  teasers:(selector, options, callback)->
    constructor = @
    throw new Error 'No defined teaser fields.'  unless @teaserFields?
    [callback, options] = [options, callback]  unless callback
    options or= {}
