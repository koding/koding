...
module.exports = class Bongo extends EventEmitter
  ...
  constructor:(options)->
    {@mq, @mongo, @resourceName, @root, @fetchClient, @verbose, models} = options
    @setClient @mongo
    ...
    @mq?.ready => @mq.connection?.on 'error', Bongo.throwIt
    @setMaxListeners 0
  ...
  publishEventToExchange:(exchangeEvent, {routingKey, event, contents})->
    @mq.connection.exchange exchangeEvent, EXCHANGE_OPTIONS, (exchange)->
