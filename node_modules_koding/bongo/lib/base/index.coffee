...
module.exports = class Base extends EventEmitter2
  ...
  ###
  defineProperty(@, 'constructors', value: Object.create null)
  ###
  @property.
  @signature: Base.sharedConstructors
  @description - an array of shared constructors.
  ###
  defineProperty(@, 'sharedConstructors', value: Object.create null)
  defineProperty(@, 'globalSharedConstructors', value: Object.create null)
  ###
  @method: property of the constructor.
  ...
  @testSignature = (context, method, args) ->
    signatures = @getSignature context, method
    signatures = [signatures]  unless Array.isArray signatures
    for signature in signatures
      return yes  if signature.test args
    return no
  ...
  @byPassBatching =->
    ...
    konstructor = Base.sharedConstructors[name]
    console.log "byPassBatching called ", konstructor
    defineProperty konstructor, 'isByPassBatchingEnabled', value: yes
    Base.sharedConstructors[name] = konstructor
    return this
