...
module.exports = class Base extends EventEmitter2
  ...
  constructor:(options={})->
    ...
    @on '*', (rest...)=>
      @constructor.bongos.forEach (bongo)=>
        if !@constructor.instanceEvents_?
          ...
          # TODO: this is incesure by default :(
          {filter} = @constructor.sharedEvents?.instance[@event] or {}
          rest = filter.call this, rest  if 'function' is typeof filter
          bongo.handleEvent 'instance', this, @event, rest
  ...
  @setSharedMethods =(methods)->
    groupedMethods = getGroupedUnique methods
    for own group, methodsByGroup of groupedMethods
      defineProperty this, "#{group}Methods_", value: Object.keys methodsByGroup
    defineProperty this, 'sharedMethods', value: methods, enumerable: yes
  ...
  setSharedEvents:(events)->
    ...
    for own group, eventsByGroup of groupedEvents
      console.log m: '#{group}Events_'
      defineProperty this, '#{group}Events_', value: Object.keys eventsByGroup
    defineProperty this, 'sharedEvents', value: events, enumerable: yes
