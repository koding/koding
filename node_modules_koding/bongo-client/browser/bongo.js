...
require.define("/node_modules/scrubber/index.js",function(require,module,exports,__dirname,__filename,process){var Scrubber, Traverse, async, global,
  __slice = [].slice;
    ...
    this.out = new Traverse(obj).map(function() {
      ...
      return steps.forEach(function(step) {
        return queue.push(function(next) {
          return step.call(scrubber, cursor, next);
        });
      });
    });
    return async.series(queue, function() {
      return callback(scrubber);
    });
  };
...
require.define("/node_modules/async/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"lib/async.js"}});

require.define("/node_modules/async/lib/async.js",function(require,module,exports,__dirname,__filename,process){/*!
 * async
...
Bongo = (function(_super) {
  var BATCH_CHUNK_MS, CONNECTED, CONNECTING, DISCONNECTED, EventBus, JsPath, Model, NOTCONNECTED, OpaqueType, Scrubber, Signature, Store, Traverse, addGlobalListener, createBongoName, createId, extend, getEventChannelName, getRevivingListener, guardMethod, slice, _ref, _ref1, _ref2;
  ...
  _ref2 = require('sinkrow'), Bongo.daisy = _ref2.daisy, Bongo.dash = _ref2.dash, Bongo.sequence = _ref2.sequence, Bongo.race = _ref2.race;
  ...
  Bongo.prototype.createRemoteApiShims = function(api) {
    var attributes, instance, name, shimmedApi, statik, _ref3;
    shimmedApi = {};
    for (name in api) {
      if (!__hasProp.call(api, name)) continue;
      _ref3 = api[name], statik = _ref3.statik, instance = _ref3.instance, attributes = _ref3.attributes;
  ...
  Bongo.prototype.reviveType = function(type, shouldWrap) {
    ...
    revived = (_ref3 = (_ref4 = this.api[type]) != null ? _ref4 : window[type]) != null ? _ref3 : (_base = this.opaqueTypes)[type] != null ? _base[type] : _base[type] = new OpaqueType(type);
    if (shouldWrap) {
      return [revived];
    } else {
      return revived;
  ...
  Bongo.prototype.sendXhr = function(url, method, queue) {
    ...
    xhr.onreadystatechange = (function(_this) {
      return function() {
        var request, requests, _i, _len, _ref3, _results;
        if (xhr.status === 0) {
          return;
        }
        if (xhr.status >= 400) {
        ...
        if ((_ref3 = xhr.status) !== 200 && _ref3 !== 304) {
          return;
        }
