...
require.define("/node_modules_koding/bongo-client/src/scrubber.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = BongoScrubber = (function(_super) {
    var createFailHandler, error, latencyCompensation, noop;
    ...
    latencyCompensation = function(cursor) {
    ...
    function BongoScrubber() {
      ...
      this.unshift(latencyCompensation);
    }
...
require.define("/node_modules_koding/bongo-client/src/model.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = Model = (function(_super) {
    ...
    Model.streamModels = function(selector, options, callback) {
      if (this.cursor == null) {
        throw new Error("streamModels depends on cursor, but cursor was not found!\n(Hint: it may not be whitelisted)");
      }
      return this.cursor(selector, options, function(err, cursor) {
        var ids;
        if (err) {
          return error(err);
        } else {
          ...
          return cursor.each(function(err, doc) {
            if (err) {
              ...
              ids.push(typeof doc.getId === "function" ? doc.getId() : void 0);
...
require.define("/node_modules_koding/bongo-client/src/eventbus.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = EventBus = (function() {
    var ListenerTree, getRoutingKey;
    ...
    function EventBus(mq) {
      ...
      this.oids = {};
      this.channel = this.mq.subscribe('updateInstances', {
        fineGrained: true
      });
    }

    EventBus.prototype.dispatch = function(payload, routingKey) {
      return this.tree.emit(routingKey, payload);
    };

    getRoutingKey = function(oid, event) {
    ...
    EventBus.prototype.on = function(inst, event, listener) {
      var oid;
      oid = inst.getId();
      if (this.oids[oid] == null) {
        this.oids[oid] = 0;
        this.channel.on(getRoutingKey(oid, '#'), this.dispatch.bind(this));
      }
      this.oids[oid]++;
      return this.tree.on(getRoutingKey(oid, event), listener);
    };
    ...
    EventBus.prototype.off = function(inst, event, listener) {
      ...
      return this.tree.off(getRoutingKey(oid, event), listener);
    };
...
require.define("/node_modules/kdml/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index.js"}});

require.define("/node_modules/kdml/index.js",function(require,module,exports,__dirname,__filename,process){module.exports = require('./lib/kdml');});

require.define("/node_modules/kdml/lib/kdml/index.js",function(require,module,exports,__dirname,__filename,process){var KDMLParser, SaxParser,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/node_modules/kdml/lib/kdml/saxparser.js",function(require,module,exports,__dirname,__filename,process){var EventEmitter, KDSaxParser,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
require.define("/node_modules/kdml/node_modules/node-xml/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"./lib/node-xml"}});

require.define("/node_modules/kdml/node_modules/node-xml/lib/node-xml.js",function(require,module,exports,__dirname,__filename,process){// node-xml
...
Bongo = (function(_super) {
  var EventBus, JsPath, Model, Scrubber, Store, Traverse, addGlobalListener, createBongoName, createId, dash, extend, getEventChannelName, getRevivingListener, race, sequence, slice, _ref, _ref1;
  ...
  Bongo.KDML = require('kdml');

  slice = [].slice;

  extend = require('./src/util').extend;

  _ref = require('sinkrow'), race = _ref.race, sequence = _ref.sequence, dash = _ref.dash;

  _ref1 = require('sinkrow'), Bongo.daisy = _ref1.daisy, Bongo.dash = _ref1.dash, Bongo.sequence = _ref1.sequence, Bongo.race = _ref1.race, Bongo.future = _ref1.future;
  ...
  function Bongo(options) {
    var _ref2,
      _this = this;
    EventEmitter(this);
    this.mq = options.mq, this.getSessionToken = options.getSessionToken, this.getUserArea = options.getUserArea, this.fetchName = options.fetchName;
    if ((_ref2 = this.getUserArea) == null) {
  ...
  Bongo.prototype.createRemoteApiShims = function(api) {
    var instance, name, options, shimmedApi, statik, _ref2;
    shimmedApi = {};
    for (name in api) {
      _ref2 = api[name], statik = _ref2.statik, instance = _ref2.instance, options = _ref2.options;
  ...
  addGlobalListener = function(konstructor, event, listener) {
    var channel, channelName, revivingListener;
    channelName = getEventChannelName(konstructor.name);
    revivingListener = getRevivingListener(this, konstructor, listener);
    channel = this.mq.channels[channelName];
    if (channel != null) {
      return channel.on(event, revivingListener);
    } else {
      channel = this.mq.subscribe(channelName);
      return channel.on('broker:bind_succeeded', function() {
        return channel.on(event, revivingListener);
      });
    }
  };
    ...
    return function(instances, callback) {
      ...
      return callback(null, instances.map(function(instance) {
        if (instance.snapshot != null) {
          return _this.revive(JSON.parse(instance.snapshot, snapshotReviver));
        }
      }));
    };
  })();
  ...
  Bongo.prototype.connect = function(callback) {
    ...
    return this.channel.once('broker:bind_succeeded', function() {
      if (callback != null) {
        _this.mq.once('connected', callback.bind(_this));
      }
