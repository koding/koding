...
exports.Store = DnodeStore = (function(_super) {
  ...
  DnodeStore.prototype.cull = function(id) {
  ...
  DnodeStore.prototype.wrap = function(fn, id) {
    return (function(_this) {
      return function() {
        fn.apply(_this, arguments);
        return _this.autoCull(fn, id);
      };
    })(this);
  };

  DnodeStore.prototype.autoCull = function(fn, id) {
...
Bongo = (function(_super) {
  ...
  Bongo.prototype.createRemoteApiShims = function(api) {
    var attributes, instance, name, shimmedApi, statik, _ref4;
    shimmedApi = {};
    for (name in api) {
      if (!__hasProp.call(api, name)) continue;
      _ref4 = api[name], statik = _ref4.statik, instance = _ref4.instance, attributes = _ref4.attributes;
