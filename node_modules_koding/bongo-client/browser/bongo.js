...
require.define("/node_modules_koding/bongo-client/src/eventbus.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = EventBus = (function() {
    var ListenerTree, getGenericRoutingKey, getRoutingKey;
    ...
    getGenericRoutingKey = function(oid) {
    ...
    EventBus.prototype.on = function(inst, event, listener) {
      ...
      if (this.oids[oid] == null) {
        this.oids[oid] = 0;
        this.channel.on(getGenericRoutingKey(oid), this.dispatch.bind(this));
      }
      this.oids[oid]++;
...
Bongo = (function(_super) {
  var EventBus, JsPath, Model, OpaqueType, Scrubber, Store, Traverse, addGlobalListener, createBongoName, createId, dash, extend, getEventChannelName, getRevivingListener, race, sequence, slice, _ref, _ref1;
  ...
  function Bongo(options) {
    ...
    this.channelName = createBongoName();
    ...
    this.mq.on('disconnected', this.bound('emit', 'disconnected'));
    this.opaqueTypes = {};
  ...
  Bongo.prototype.getTimeout = function(message, clientTimeout) {
    ...
    return setTimeout(this.bound('messageFailed', message), clientTimeout);
  };
