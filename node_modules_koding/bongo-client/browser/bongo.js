...
require.define("/node_modules_koding/bongo-client/src/model.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = Model = (function(_super) {
    var EventMultiplexer, JsPath, MongoOp, Traverse, createId, extend;
...
Bongo = (function(_super) {
  var BATCH_CHUNK_MS, CONNECTED, CONNECTING, DISCONNECTED, EventBus, JsPath, Model, NOTCONNECTED, OpaqueType, Scrubber, Store, Traverse, addGlobalListener, createBongoName, createId, dash, extend, getEventChannelName, getRevivingListener, race, sequence, slice, _ref, _ref1, _ref2, _ref3;
  ...
  function Bongo(options) {
    var _this = this;
    EventEmitter(this);
    this.mq = options.mq, this.getSessionToken = options.getSessionToken, this.getUserArea = options.getUserArea, this.fetchName = options.fetchName, this.resourceName = options.resourceName, this.precompiledApi = options.precompiledApi, this.apiEndpoint = options.apiEndpoint, this.useWebsockets = options.useWebsockets, this.batchRequests = options.batchRequests;
  ...
  Bongo.prototype.setOutboundTimer = function() {
    var _this = this;
    this.outboundQueue = [];
    return this.outboundTimer = setInterval(function() {
  ...
  Bongo.prototype.xhrHandshake = function() {
    var _this = this;
    return this.send('xhrHandshake', function(api) {
      if (_this.api) {
