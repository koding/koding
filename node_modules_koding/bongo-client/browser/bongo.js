...
Bongo = (function(_super) {
  ...
  function Bongo(options) {
    ...
    this.mq = options.mq, this.getSessionToken = options.getSessionToken, this.getUserArea = options.getUserArea, this.fetchName = options.fetchName, this.resourceName = options.resourceName, this.precompiledApi = options.precompiledApi, this.apiEndpoint = options.apiEndpoint;
    console.log({
  ...
  Bongo.prototype.sendXhr = function(url, method, body) {
    ...
    xhr.onreadystatechange = function() {
      ...
      if (xhr.status === 0 || xhr.status >= 400) {
        _this.emit('error', new Error("Error: " + xhr.status));
      }
      if (xhr.readyState !== 4) {
        return;
      }
      ...
      return _this.handleRequest(JSON.parse(xhr.response));
    };
