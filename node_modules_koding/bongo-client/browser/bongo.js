...
require.define("/node_modules_koding/bongo-client/src/eventbus.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = EventBus = (function() {
    ...
    EventBus.prototype.on = function(inst, event, listener) {
      var channel, genericRoutingKey, oid;
      oid = inst.getId();
      if (this.channels[oid] == null) {
        this.counts[oid] = 0;
        genericRoutingKey = getGenericRoutingKey(oid);
        channel = this.channels[oid] = this.mq.subscribe(genericRoutingKey, {
          isReadOnly: true
        });
        channel.on(event, this.dispatch.bind(this, getRoutingKey(oid, event)));
    ...
    EventBus.prototype.off = function(inst, event, listener) {
      var channel, oid;
      oid = inst.getId();
      if (0 === --this.counts[oid]) {
        channel = this.channels[oid];
        channel.close();
        delete this.channels[oid];
      }
