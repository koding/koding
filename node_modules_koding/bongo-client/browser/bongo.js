...
exports.Scrubber = DnodeScrubber = (function(_super) {
  ...
  function DnodeScrubber(store, stack) {
...
require.define("/node_modules_koding/bongo-client/src/model.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = Model = (function(_super) {
    var EventMultiplexer, JsPath, MongoOp, createId, extend, _ref;
    ...
    Model.prototype.decoded = (typeof KD !== "undefined" && KD !== null ? (_ref = KD.utils) != null ? _ref.htmlDecode : void 0 : void 0) != null ? function(path) {
      return KD.utils.htmlDecode(this.getAt(path));
    ...
    Model.prototype.valueOf = function() {
      var _ref1;
      return (_ref1 = typeof this.getValue === "function" ? this.getValue() : void 0) != null ? _ref1 : this;
    };
    ...
    Model.prototype.update_ = function(data) {
      ...
      Object.keys(fields).forEach(function(field) {
        var _ref1;
        return (_ref1 = _this.watchers[field]) != null ? _ref1.forEach(function(watcher) {
...
Bongo = (function(_super) {
  ...
  Bongo.prototype.revive = function(obj) {
    var bongo, hasEncoder, _ref4;
    bongo = this;
    hasEncoder = (typeof KD !== "undefined" && KD !== null ? (_ref4 = KD.utils) != null ? _ref4.xssEncode : void 0 : void 0) != null;
    return new Traverse(obj).map(function(node) {
      var constructorName, instance, instanceId, konstructor, _ref5;
      if ((node != null ? node.bongo_ : void 0) != null) {
        _ref5 = node.bongo_, constructorName = _ref5.constructorName, instanceId = _ref5.instanceId;
        ...
        return this.update(KD.utils.xssEncode(node));
      } else {
        return this.update(node);
      }
    });
