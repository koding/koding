...
Bongo = (function(_super) {
  ...
  function Bongo(options) {
    ...
    this.mq.on('broker.disconnected', this.emit.bind(this, 'disconnected'));
    this.opaqueTypes = {};
  ...
  Bongo.prototype.subscribe = function(name, options, callback) {
    ...
    if ((_ref2 = options.serviceType) == null) {
      options.serviceType = 'application';
    }
    channel = this.mq.subscribe(name);
    ...
    if (callback != null) {
      channel.on('broker.subscribed', function() {
        return callback(channel);
      });
    }
    return channel;
