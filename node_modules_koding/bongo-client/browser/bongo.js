...
Bongo = (function(_super) {
  ...
  function Bongo(options) {
    var _ref2,
      _this = this;
    EventEmitter(this);
    this.mq = options.mq, this.getSessionToken = options.getSessionToken, this.getUserArea = options.getUserArea, this.fetchName = options.fetchName, this.resourceName = options.resourceName;
  ...
  addGlobalListener = function(konstructor, event, listener) {
    ...
    if (channel != null) {
      ...
      return channel.on('broker.subscribed', function() {
        return channel.on(event, revivingListener);
      });
    }
  };
  ...
  Bongo.prototype.connect = function(callback) {
    ...
    return this.channel.once('broker.subscribed', function() {
      ...
      _this.channel.on('message', _this.bound('handleRequest'));
      if (!_this.readyState) {
        setTimeout(_this.emit.bind(_this, 'connected'), 75);
      } else {
