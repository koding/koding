...
Bongo = (function(_super) {
  var EventBus, JsPath, Model, OpaqueType, Scrubber, Store, Traverse, addGlobalListener, compensateForCreateMethodLatency, createBongoName, createId, dash, extend, getEventChannelName, getRevivingListener, race, sequence, slice, _ref, _ref1;
  ...
  compensateForCreateMethodLatency = function() {
    ...
    return function(constructor, constructorName, statik) {
      ...
      return statik.forEach(function(method) {
        ...
        return constructor[method] = function() {
          ...
          if (method === 'create') {
            compensateForCreateMethodLatency.apply(null, rest);
          }
  ...
  Bongo.prototype.reviveType = function(type, shouldWrap) {
    var revived, _base, _ref2, _ref3, _ref4;
    ...
    revived = (_ref2 = (_ref3 = this.api[type]) != null ? _ref3 : window[type]) != null ? _ref2 : (_ref4 = (_base = this.opaqueTypes)[type]) != null ? _ref4 : _base[type] = new OpaqueType(type);
    if (shouldWrap) {
      return [revived];
    } else {
      return revived;
