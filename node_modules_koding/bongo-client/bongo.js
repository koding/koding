...
Bongo = (function(_super) {
  ...
  Bongo.prototype.sendHelper = function(message) {
    var byPassBatching, messageString, _ref4, _ref5;
    if (this.useWebsockets) {
      ...
      if ((_ref4 = (_ref5 = message.method) != null ? _ref5.constructorName : void 0) === "SocialMessage" || _ref4 === "SocialChannel") {
        byPassBatching = true;
      }
      if (this.batchRequests && !byPassBatching) {
