module.exports = class Broker
  ...
  emit: (channel, event, payload, options = {}) ->
    ...
    exchangeOptions = 
      durable     : no  #unless durable? then true else durable
      autoDelete  : yes  #unless autoDelete? then true else autoDelete
      type        : 'fanout'

    delete options.durable
    delete options.autoDelete

    payload += ''  unless typeof payload is 'object' and payload isnt null
