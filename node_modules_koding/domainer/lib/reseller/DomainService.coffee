...
module.exports = class DomainService extends ServiceManager
  ...
  createProxyRule:(params, callback)->
    options =
      method  : 'POST'
      uri     : "http://kontrol.in.koding.com/restrictions/#{params.domainName}/rules"
  ...
  createBehavior: (params, callback)->
    options = 
      method : 'POST'
  ...
  deleteBehavior: (params, callback)->
    options = 
      method : "DELETE"
      uri    : "http://kontrol.in.koding.com/restrictions/#{params.domainName}/list/#{params.ruleName}"
  ...
  updateBehavior: (params, callback)->

    @deleteBehavior params, (err, response)=>
      if not err
        @createBehavior params, callback
  ...
  _returnResponse:(error, response, body, callback)->
    ...
    if response.statusCode is 200
      ...
      return callback resBody.err if resBody.err?
