...
Connection.prototype.connect = function () {
  ...
  // failing silently.
  var possibleAuthErrorHandler = this.emit.bind(this, 'error', {
    message: 'Connection ended: possibly due to an authentication error.'
  })
  this.once('end', possibleAuthErrorHandler);
...
Connection.prototype._inboundHeartbeatTimerReset = function () {
  ...
  if (this.options.heartbeat) {
    ...
    this._inboundHeartbeatTimer = setTimeout(function () {
      return emitError(self, 'no heartbeat or data in last ' + gracePeriod + ' seconds');
    }, gracePeriod * 1000);
  }
};
