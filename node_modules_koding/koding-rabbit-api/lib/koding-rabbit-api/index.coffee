  ...
  crypto.randomBytes 12, (ex, buf) ->
    ...
    apiSet "users/#{username}", args, (err, data) ->
      if err
        ...
        args2 =
          configure : "^(amq\.gen.*|amq\.default|services-presence|broker|kite-#{key}-.*)$"
          write     : "^(amq\.gen.*|amq\.default|services-presence|broker|kite-#{key}-.*)$"
          read      : "^(amq\.gen.*|amq\.default|services-presence|broker|kite-#{key}-.*)$"
