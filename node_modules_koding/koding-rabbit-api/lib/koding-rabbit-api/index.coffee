  ...
  crypto.randomBytes 12, (ex, buf) ->
    ...
    apiSet "users/#{username}", args, (err, data) ->
      if err
        ...
        args2 =
          configure : "^(amq\.gen.*|amq\.default|services-presence|accounting|broker|kite-#{kiteName}-.*)$"
          write     : "^(amq\.gen.*|amq\.default|services-presence|accounting|broker|kite-#{kiteName}-.*)$"
          read      : "^(amq\.gen.*|amq\.default|services-presence|accounting|broker|kite-#{kiteName}-.*)$"
