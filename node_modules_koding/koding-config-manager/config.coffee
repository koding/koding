...
class Config extends EventEmitter
  ...
  check: ->
    ...
    if configType is "" or configType is "undefined"
      @path = a.join(".")+"."+configSchema._selfConfig?.defaultConfig
      console.log "[KONFIG-MANAGER] Default config is set to: '#{configSchema._selfConfig?.defaultConfig}' at config/config.schema.coffee"
    ...
    for i,p of paths
      ...
      console.log "[KONFIG-MANAGER][ERROR] Inconsistent configuration at path:#{i} not found in #{where}"
