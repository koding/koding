  ...
  Pistachio = (function() {
    ...
    */
    ...
    Pistachio.prototype.addSymbolInternal = function(symbol) {
      var dataPath, dataPaths, subViewName, subViewNames, _i, _j, _len, _len2;
      ...
      for (_i = 0, _len = dataPaths.length; _i < _len; _i++) {
        ...
        this.symbolsByDataPath[dataPath] = symbol;
      }
      for (_j = 0, _len2 = subViewNames.length; _j < _len2; _j++) {
        subViewName = subViewNames[_j];
        this.symbolsBySubViewName[subViewName] = symbol;
      }
      return symbol;
    };
    ...
    Pistachio.prototype.refreshChildren = function(childType, items, forEach) {
      var el, item, out, symbol, symbolKey, symbols, _i, _len, _results;
      if (forEach == null) forEach = (function() {});
      symbols = this.symbols;
      symbolKey = (function() {
        switch (childType) {
          case 'subview':
            return 'symbolsBySubViewName';
          case 'path':
            return 'symbolsByDataPath';
        }
      })();
      ...
      for (_i = 0, _len = items.length; _i < _len; _i++) {
        item = items[_i];
        symbol = this[symbolKey][item];
        console.log(symbolKey, item);
        if (symbol == null) continue;
        out = symbol != null ? symbol.render() : void 0;
        el = document.getElementById(symbol.id);
        if (el == null) continue;
        if (out) {
