(function() {
  ...
  Pistachio = (function() {
    var cleanSubviewNames, coffee, pistachios,
      _this = this;

    Pistachio.MODE = typeof PISTACHIO_MODE !== "undefined" && PISTACHIO_MODE !== null ? PISTACHIO_MODE : 'development';
    ...
    if (Pistachio.MODE === 'development' && !(coffee != null)) {
    ...
    Pistachio.prototype.init = (function() {
      ...
      return function() {
        ...
        return this.template.replace(pistachios, function(_, tagName, id, classes, attrs, expression) {
          var classAttr, classNames, code, dataPaths, dataPathsAttr, embedChild, formalParameters, isCustom, js, paramKeys, paramValues, render, subViewNames, subViewNamesAttr, symbol;
          ...
          formalParameters = ['data', 'embedChild'].concat(__slice.call(paramKeys), [js]);
          try {
            code = Function.apply(null, formalParameters);
          } catch (e) {
