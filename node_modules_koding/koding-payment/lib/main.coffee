...
# This method is for user sellables.
addUserPlan = (username, data, callback) ->
  # See https://docs.recurly.com/api/plans for XML format
  data.planTitle = data.planTitle
  data.planCode = "user_#{username}_#{getUniqueId()}"
  xml = """<plan>
...
# This method is for user sellables.
deleteUserPlan = (username, data, callback) ->
  if data.planCode.indexOf("user_#{username}_") == -1
    callback yes, {}
  else
