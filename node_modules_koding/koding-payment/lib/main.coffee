        ...
        if page.plans?.plan
          for p in page.plans.plan
            plans.push
              ...
              feeMonthly : parseInt p.unit_amount_in_cents[0]['USD'][0]['_'], 10
              feeInitial : parseInt p.setup_fee_in_cents[0]['USD'][0]['_'], 10
      callback no, plans
      ...
      for page in res
        ...
        if page.plan
          plan =
            ...
            feeMonthly : parseInt page.plan.unit_amount_in_cents[0]['USD'][0]['_'], 10
            feeInitial : parseInt page.plan.setup_fee_in_cents[0]['USD'][0]['_'], 10
          callback no, plan
        else
          callback yes, {}
        break
  ...
  recurlyPost 'plans', xml, (err, res) ->
    if err
      ...
      plan =
        ...
        feeMonthly : parseInt res.plan.unit_amount_in_cents[0]['USD'][0]['_'], 10
        feeInitial : parseInt res.plan.setup_fee_in_cents[0]['USD'][0]['_'], 10
      callback no, plan
      ...
      for page in res
        ...
        if page.billing_info
          ...
          billing =
            ...
            city              : unescape info.city[0]
            state             : unescape info.state[0]
            zip               : info.zip[0]
