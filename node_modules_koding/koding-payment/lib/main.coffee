      ...
      if body.length > 0
        xml2js.parseString body, (e, r) ->
          if e
            ...
            errors = [Error(r.error.symbol[0], unescapeHTML r.error.description[0]['_'], '')]
            callback errors, {}
          else if r.errors
        ...
        if page.plans?.plan
          for p in page.plans.plan
            plans.push
              title      : p.name[0]
              code       : p.plan_code[0]
              desc       : if typeof p.description[0] is "string" then unescapeHTML p.description[0] else ""
      ...
      for page in res
        ...
        if page.plan
          plan =
            ...
            desc       : if typeof page.plan.description[0] is "string" then unescapeHTML page.plan.description[0] else ""
  ...
  recurlyPost 'plans', xml, (err, res) ->
    if err
      ...
      plan =
        ...
        desc       : if typeof res.plan.description[0] is "string" then unescapeHTML res.plan.description[0] else ""
        ...
        if page.adjustments?.adjustment
          for t in page.adjustments.adjustment
            adjustments.push
              ...
              amount      : t.total_in_cents[0]['_']
              currency    : t.currency[0]
              description : if t.description[0].$ then "" else unescapeHTML t.description[0]
              origin      : t.origin[0]
