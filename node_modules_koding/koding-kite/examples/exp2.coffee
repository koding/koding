...
{Kite, Kontrol, Environment, KiteEventListener} = require 'koding-kite'
...
kite = new Kite name: "application", username: "devrim", port: "9998"
kite.run ()->
  kite.Kontrol.getKites {name: "mathworker"}, eventListener, (err, kites)->
