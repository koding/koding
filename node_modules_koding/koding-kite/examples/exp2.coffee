...
k.Start ()->
  ...
  k.Kontrol.GetKites query, eventListener, (err, kites)->
      ...
      mathWorker.Dial ()->
        ...
        mathWorker.Call "doubleSquare", 12, (r)-> console.log "double square returned ", r.Args

        # throwing error in sync style
        mathWorker.Call "squareWithError", 12, (r)-> console.log "squareWithError returned ", r.Args

        # simple sync style
        mathWorker.Call "squareSync", 12, (r)-> console.log "squareSync returned ", r.Args
