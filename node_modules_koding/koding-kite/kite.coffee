...
class KiteConnectionWrapper extends EventEmitter
  ...
  go: (method, args, callback=noop)=>
    ...
    payload.kite =
      name: @kite.kitename
      username: @kite.settings.userName()
      id: @kite.uuid
      environment: @kite.settings.environment()
      region: @kite.settings.region()
      version: @kite.settings.version()
      hostname: @kite.settings.hostname()
      publicIP: ""
