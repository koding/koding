...
#   'token'    : new TokenAuthenticator
# worker = {}
# worker.authenticators = authenticators
# request = new Request authenticators: authenticators
# af = new AuthenticateFilter
# af.worker = worker
# f = new RequestFilters [af]
# f.runFilters request, (err, request)->
