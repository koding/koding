...
module.exports = class Module extends Model
                  ...
                  .some extend(targetSelector,
                    ...
                    if others?
                      others = for other in others
                        ...
                        other.timestamp = timestamps[other.getId()]
                        other
  ...
  remove:(callback=->)->
    id = @getId()
    Relationship.all $or: [{sourceId: id}, {targetId: id}], (err, rels)=>
      return callback err if err
      relIds = (rel._id for rel in rels)
      Relationship.remove (_id: $in: relIds), (err)=>
        return callback err if err
