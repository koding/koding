{ Base, Model, ObjectId, Inflector, Register, race } = require 'bongo'
          ...
          if err then callback err
            ...
            cursor.toArray (err, docs)->
              if err then callback err
                ...
                totalCount = 0
                queue = Object.keys(groups).map (constructorName) -> (fin) ->
                  ...
                  konstructor.count targetSelector, (err, count)->
                    ...
                    totalCount += count
                    fin()
                async.parallel queue, -> callback null, totalCount
