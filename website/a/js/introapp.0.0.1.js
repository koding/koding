...
this.addSubView(new KDCustomHTMLView({partial:"Login",cssClass:"login-button",click:function(){return KD.getSingleton("router").handleRoute("/Login")}}))
...
//@ sourceMappingURL=/js/introapp.0.0.1.js.map