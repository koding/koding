...
<<<<<<< HEAD
version = "0.9.4a" # fs.readFileSync nodePath.join(__dirname, '../.revision'), 'utf-8'
=======
version = "0.9.4d" # fs.readFileSync nodePath.join(__dirname, '../.revision'), 'utf-8'
>>>>>>> 5884de57b57d63dceb8b0189cc382e6cbfe2bd7a
