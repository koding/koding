...
Configuration = (options={}) ->
  ...
  KONFIG              =
    ...
    google                         : {client_id     : "569190240880-o8loc6it0r1pl89i5slmm7sjar3lmgfb.apps.googleusercontent.com"                                    , client_secret : "BStkPGPO5k9GWFQcKKxBBLVq"                                            , redirect_uri : "http://koding-senthil.ngrok.com/-/oauth/google/callback" }
