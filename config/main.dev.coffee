...
Configuration = (options={}) ->
  ...
  email               = { host:     "#{customDomain.public_}"                     , defaultFromMail:    'hello@koding.com'                      , defaultFromName:    'Koding'                    , forcedRecipientEmail: "aionochkin@tula.co", forcedRecipientUsername: "#{process.env.USER}"                      }
