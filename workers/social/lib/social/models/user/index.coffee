...
module.exports = class JUser extends jraphical.Module
  ...
  @login = (clientId, credentials, callback) ->
    ...
    queue = [
      ...
      ->
        loginHelper.validateLoginCredentials {
      ...
      ->
        ...
        # both should succeed
        loginHelper.fetchInvitationByCode invitationToken, queue, callback, (invitation_) ->
          invitation = invitation_

      ->
        loginHelper.fetchInvitationByData {
