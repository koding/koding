...
<section class="kdview" id="main-panel-wrapper">
  ...
  <div class="kdview" id="sidebar"><div id="main-nav">
  <div class="avatar-placeholder">
    <div id="avatar-area">
      <div class="avatarview avatar-image-wrapper" title="View your public profile" ><cite></cite></div>
    </div>
  </div>
...
<div id="finder-panel">
  ...
  <div id="finder-holder">
    <div class="kdview nfinder file-container"><div class="kdview kdscrollview jtreeview-wrapper"></div><div class="kdview no-vm-found-widget"><span class="kdview kdloader"><span id="cl_kd-149" class="canvas-loader"><canvas width="20" height="20"></canvas><canvas width="20" height="20"></canvas></span></span>
