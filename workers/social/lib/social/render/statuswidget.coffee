      ...
      <div class="kdview kdscrollview kdtabview update-widget-tabs">
        <div class="kdview kdtabpaneview update clearfix no-shadow active">
          <form class="kdformview status-widget">
            <div class="small-input"><input name="dummy" type="text" class="kdinput text status-update-input warn-on-unsaved-data" placeholder="What's new #{validator.sanitize(firstName).xss()}?"></div>
          </form>
        </div>
      </div>
    </div>
