...
func saveKiteKeySh() (*asset, error) {
	bytes, err := saveKiteKeyShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "save-kite-key.sh", size: 1197, mode: os.FileMode(493), modTime: time.Unix(1441413197, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"save-kite-key.sh": saveKiteKeySh,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"save-kite-key.sh": &bintree{saveKiteKeySh, map[string]*bintree{
	}},
}}
