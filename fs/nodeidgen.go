...
// It is threadsafe and guaranteed to return unique ids.
...
// NewNodeIDGen is the required initializer for NodeIDGen. It sets LastID
// to fuseops.RootInodeID, ie 1 since that's the default ID for root.
