...
func main() {
	...
	http.HandleFunc("/appauth/client_credentials", func(w http.ResponseWriter, r *http.Request) {
		fmt.Println("/appauth/client_credentials")
		r.ParseForm()
