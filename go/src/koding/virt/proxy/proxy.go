...
func main() {
	...
	go fastproxy.ListenFTP(&net.TCPAddr{IP: net.IPv4(192, 168, 0, 104), Port: 21}, net.IPv4(192, 168, 0, 104), nil, func(req *fastproxy.FTPRequest) {
	...
	fastproxy.ListenHTTP(&net.TCPAddr{IP: nil, Port: 80}, nil, false, func(req *fastproxy.HTTPRequest) {
		defer log.RecoverAndLog()
