...
func newKite(kconf *KlientConfig) *kite.Kite {
	...
	// Currently kite.key generated by kontrol injects
	// default value of the kontrolUrl (http://127.0.0.1:3000/kite) and
	// assumes it would get overwritten to a proper one during klient
	// installation or start up.
	//
	// Ensure that any default value is overwritten with default kontrol.
	//
	// TODO(rjeczalik): ensure kontrolUrl is set to a proper value.
	if k.Config.KontrolURL == "http://127.0.0.1:3000/kite" {
		k.Config.KontrolURL = "https://koding.com/kontrol/kite"
	}
