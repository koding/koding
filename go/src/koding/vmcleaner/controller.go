...
func (c *Controller) SendEmail(user *models.User, levelId int) error {
	...
	return c.Email.SendTemplateEmail(user.Email, templateId, nil)
}

func (c *Controller) DeleteVM(user *models.User, levelId int) error {
	return nil
}
