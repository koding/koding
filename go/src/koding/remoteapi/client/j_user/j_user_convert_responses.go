...
// JUserConvertReader is a Reader for the JUserConvert structure.
type JUserConvertReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *JUserConvertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
...
// NewJUserConvertOK creates a JUserConvertOK with default headers values
func NewJUserConvertOK() *JUserConvertOK {
	return &JUserConvertOK{}
}

/*JUserConvertOK handles this case with default header values.
...
// NewJUserConvertUnauthorized creates a JUserConvertUnauthorized with default headers values
func NewJUserConvertUnauthorized() *JUserConvertUnauthorized {
	return &JUserConvertUnauthorized{}
}

/*JUserConvertUnauthorized handles this case with default header values.
