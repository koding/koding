...
// PostRemoteAPIJAccountUpdateFlagsIDReader is a Reader for the PostRemoteAPIJAccountUpdateFlagsID structure.
type PostRemoteAPIJAccountUpdateFlagsIDReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *PostRemoteAPIJAccountUpdateFlagsIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {

	case 200:
		result := NewPostRemoteAPIJAccountUpdateFlagsIDOK()
...
// NewPostRemoteAPIJAccountUpdateFlagsIDOK creates a PostRemoteAPIJAccountUpdateFlagsIDOK with default headers values
func NewPostRemoteAPIJAccountUpdateFlagsIDOK() *PostRemoteAPIJAccountUpdateFlagsIDOK {
	return &PostRemoteAPIJAccountUpdateFlagsIDOK{}
}

/*PostRemoteAPIJAccountUpdateFlagsIDOK handles this case with default header values.
...
func (o *PostRemoteAPIJAccountUpdateFlagsIDOK) Error() string {
	return fmt.Sprintf("[POST /remote.api/JAccount.updateFlags/{id}][%d] postRemoteApiJAccountUpdateFlagsIdOK  %+v", 200, o.Payload)
}
