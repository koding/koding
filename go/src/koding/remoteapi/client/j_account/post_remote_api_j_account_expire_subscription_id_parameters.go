...
// WithBody adds the body to the post remote API j account expire subscription ID params
func (o *PostRemoteAPIJAccountExpireSubscriptionIDParams) WithBody(body models.DefaultSelector) *PostRemoteAPIJAccountExpireSubscriptionIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post remote API j account expire subscription ID params
func (o *PostRemoteAPIJAccountExpireSubscriptionIDParams) SetBody(body models.DefaultSelector) {
	o.Body = body
}
