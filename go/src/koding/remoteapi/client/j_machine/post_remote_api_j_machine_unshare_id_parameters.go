...
// WithBody adds the body to the post remote API j machine unshare ID params
func (o *PostRemoteAPIJMachineUnshareIDParams) WithBody(body models.DefaultSelector) *PostRemoteAPIJMachineUnshareIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post remote API j machine unshare ID params
func (o *PostRemoteAPIJMachineUnshareIDParams) SetBody(body models.DefaultSelector) {
	o.Body = body
}
