...
func main() {
	...
	r.Register(models.NotificationSetting{}).OnCreate().Handle((*realtime.Controller).NotificationSettingSaved)
	r.Register(models.NotificationSetting{}).OnDelete().Handle((*realtime.Controller).NotificationSettingDeleted)
	r.Register(models.NotificationSetting{}).OnUpdate().Handle((*realtime.Controller).NotificationSettingUpdated)
