...
<p style="color:#565656;font-size:14px;margin:40px 0 20px;line-height:21px;">
{{ .UserID }}, 
        <br /><br />
        Thank you for signing up on Koding.com. In order to gain access to your virtual machine and other Koding resources, please use the PIN code above to activate your account.
    </p>
</div>
...
var TemplateSignupText = `Hi {{ .UserID }},
