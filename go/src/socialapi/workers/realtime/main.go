...
func main() {
	...
	m.HandleFunc("api.channel_message_list_pinned_channel_list_updated", (*realtime.Controller).PinnedChannelListUpdated)
	m.HandleFunc("api.channel_message_list_updated", (*realtime.Controller).ChannelMessageListUpdated)
