...
CREATE TABLE "notification"."notification" (
    "id" int8 NOT NULL DEFAULT nextval('notification.notification_id_seq'::regclass),
...
CREATE TABLE "notification"."notification_content" (
    "id" int8 NOT NULL DEFAULT nextval('notification.notification_content_id_seq'::regclass),
...
CREATE TABLE "notification"."notification_activity" (
    "id" int8 NOT NULL DEFAULT nextval('notification.notification_activity_id_seq'::regclass),
