...
CREATE TABLE "api"."channel" (
    "id" bigint NOT NULL DEFAULT nextval('channel_id_seq'::regclass),
...
CREATE TABLE "api"."channel_message" (
    "id" bigint NOT NULL DEFAULT nextval('channel_message_id_seq'::regclass),
...
CREATE TABLE "api"."interaction" (
    "id" bigint NOT NULL DEFAULT nextval('interaction_id_seq'::regclass),
    "message_id" bigint NOT NULL DEFAULT 0,
    "account_id" bigint NOT NULL DEFAULT 0,
    "type_constant" varchar(100) NOT NULL COLLATE "default",
    "created_at" timestamp(6) WITH TIME ZONE NOT NULL DEFAULT now()
