...
# create sequences
sudo -u postgres psql social < $1/integration_definition/003-sequence.sql

# create tables
sudo -u postgres psql social < $1/integration_definition/004-table.sql

# create constraints
sudo -u postgres psql social < $1/integration_definition/005-constraint.sql
