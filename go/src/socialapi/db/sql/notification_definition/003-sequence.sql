...
-- ALTER TABLE "notification"."notification_id_seq" OWNER TO "socialapplication";
GRANT USAGE ON SEQUENCE "notification"."notification_id_seq" TO "socialapplication";
...
-- ALTER TABLE "notification"."notification_content_id_seq" OWNER TO "socialapplication";
GRANT USAGE ON SEQUENCE "notification"."notification_content_id_seq" TO "socialapplication";
...
-- ALTER TABLE "notification"."notification_activity_id_seq" OWNER TO "socialapplication";
GRANT USAGE ON SEQUENCE "notification"."notification_activity_id_seq" TO "socialapplication";