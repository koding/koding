...
-- ----------------------------
CREATE TYPE "payment"."provider" AS ENUM (
    'stripe',
    'paypal'
);
ALTER TYPE "payment"."provider" OWNER TO "social";
...
-- ----------------------------
CREATE TYPE "payment"."plan_interval" AS ENUM (
    'month',
    'year'
);
ALTER TYPE "payment"."plan_interval" OWNER TO "social";

CREATE TYPE "payment"."plan_title" AS ENUM (
    'free',
    'hobbyist',
    'developer',
    'professional'
