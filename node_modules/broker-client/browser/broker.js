...
require.define("/node_modules/broker-client/lib/broker-client/broker.js",function(require,module,exports,__dirname,__filename,process,global){var Broker;
...
module.exports = Broker = (function() {
  ...
  function Broker(app_key, options) {
    var backoff, initalDelayMs, maxDelayMs, maxReconnectAttempts, multiplyFactor, totalReconnectAttempts, _ref, _ref1, _ref2, _ref3,
      _this = this;
    ...
    initalDelayMs = (_ref = backoff.initialDelayMs) != null ? _ref : 700;
    multiplyFactor = (_ref1 = backoff.multiplyFactor) != null ? _ref1 : 1.4;
    maxDelayMs = (_ref2 = backoff.maxDelayMs) != null ? _ref2 : 1000 * 60 * 15;
    maxReconnectAttempts = (_ref3 = backoff.maxReconnectAttempts) != null ? _ref3 : 10;
  ...
  Broker.prototype.presenceOn = function(who, where, listener) {
    ...
    return this.ws.addEventListener("message", function(e) {
      ...
      if (data.channel !== "KDPresence-" + where) {
        return;
      }
      if (data.event !== "broker:presence") {
        return;
      }
...
require.define("/node_modules/broker-client/lib/broker-client/channel.js",function(require,module,exports,__dirname,__filename,process,global){var Channel;
...
require.define("/node_modules/broker-client/lib/broker-client/util.js",function(require,module,exports,__dirname,__filename,process,global){
module.exports = (function() {
  ...
  sendWsMessage = function(ws, event, exchange, options) {
    ...
    console.log('sendWsMessage', arguments);
    if (ws.readyState > 0) {
      subJSON = {
        event: event,
        exchange: exchange
