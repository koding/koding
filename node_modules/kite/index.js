...
module.exports = Kite = (function() {
  ...
  Kite.prototype.startRequestHandler = function(config) {
    ...
    return requestHandler.on('exit', __bind(function(code) {
  ...
  Kite.prototype.handleRequest = function(data, res) {
    ...
    log(this.kiteName, 'HANDLING REQUEST on behalf of', data.username, data);
    ...
    return this.unscrubMessage(requesterId, scrubbed, __bind(function(unscrubbed) {
      var callback, callbackId, channel, kallback, secretChannelId, subscriberCount, toDo, withArgs, _base, _base2, _base3, _ref3;
      ...
      switch (toDo) {
        ...
        case '_disconnect':
          log('DISCONNECTION EVENT RECEIVED');
          if (requesters[requesterId] != null) {
