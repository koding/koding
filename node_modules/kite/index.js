var Kite, Pusher, Scrubber, Store, express, pusher, _ref;
...
module.exports = Kite = (function() {
  ...
  function Kite(api) {
    ...
    this.app.get('/', __bind(function(req, res) {
      ...
      return this.unscrubMessage(requesterId, scrubbed, __bind(function(unscrubbed) {
        ...
        switch (toDo) {
          ...
          case '_disconnect':
            ...
            break;
          default:
            if (api.propertyIsEnumerable(toDo) && 'function' === typeof api[toDo]) {
  ...
  Kite.prototype.run = function(config) {
    var logPath, pidPath, port;
    port = config.port, pidPath = config.pidPath, logPath = config.logPath;
    if (pidPath) {
