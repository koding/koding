...
module.exports = class Kite
  ...
  handleError:(replyTo, callbackId='uncaughtException', err)->
    err = serializableError(err)
    @connection.publish replyTo, stringify(
      arguments : [err]
      method    : callbackId
      callbacks : {}
    ),{
  ...
  handleRequest:(message, kiteConfig, {headers, deliveryInfo})->
    ...
    catch err then @handleError deliveryInfo.replyTo, null, err
      ...
      switch toDo
        when '_disconnect'
          if requesters[requesterId]?
            ...
            @handleError deliveryInfo.replyTo, callbackId, {
        ...
        when '_ping' then @handleResponse deliveryInfo.replyTo, callbackId, 1
          ...
          else @handleError deliveryInfo.replyTo, callbackId, {
