...
module.exports = Kite = (function() {
  ...
  Kite.prototype.handleError = function(replyTo, callbackId, err) {
    if (callbackId == null) {
  ...
  Kite.prototype.handleRequest = function(message, kiteConfig, _arg) {
    ...
    try {
      ...
      this.handleError(deliveryInfo.replyTo, null, err);
    }
      ...
      switch (toDo) {
        case '_disconnect':
          if (requesters[requesterId] != null) {
            ...
            return _this.handleError(deliveryInfo.replyTo, callbackId, {
          ...
          if (_this.api.propertyIsEnumerable(toDo) && 'function' === typeof _this.api[toDo]) {
            ...
            return typeof (_base2 = _this.api)[toDo] === "function" ? _base2[toDo](withArgs, function(err, msg) {
              if (channels[exchangeName] != null) {
                return _this.handleResponse(deliveryInfo.replyTo, callbackId, [].slice.call(arguments));
              }
            }) : void 0;
          } else {
            return _this.handleError(deliveryInfo.replyTo, callbackId, {
  ...
  Kite.prototype.getExchangeName = function() {
    var exchangeName, parts, secret;
    parts = this.getQueueName().split('-');
    secret = crypto.createHash('md5').update('' + parts.pop() + 42).digest('hex');
    exchangeName = ['secret', 'kite', secret].join('-');
    console.log(exchangeName);
    return exchangeName + '.private';
  };
