...
module.exports = Kite = (function() {
  ...
  Kite.prototype.join = function(_arg, config) {
    ...
    console.log('"joining"', user, queue);
    return this.connection.queue(queue, function(queue) {
  ...
  Kite.prototype.registerSelf = function(config) {
    ...
    console.log(this.connection, options);
    return this.connection.on('ready', function() {
      console.log('the connection is ready', _this.getQueueName());
      return _this.connection.queue(_this.getQueueName(), function(queue) {
        console.log('got the q mo hey now');
        return queue.subscribe(function(message, headers, deliveryInfo) {
          console.log('holy shit actually got a message!!');
          return _this.join(JSON.parse('' + message.data), config);
        });
      });
    });
  };
