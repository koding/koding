...
EventEmitter = require('events').EventEmitter;
Bongo = (function() {
  var JsPath, Model, Scrubber, Store, Traverse, createBongoName, createId, dash, extend, race, sequence, slice, _ref, _ref2, _ref3;
  ...
  Bongo.prototype.reviveFromSnapshots = function(instances, callback) {
    return callback(null, instances.map(__bind(function(instance) {
      if (instance.snapshot != null) {
        return this.revive(JSON.parse(instance.snapshot));
      }
    }, this)));
  };
      ...
      unscrubbed = scrubber.unscrub(message, __bind(function(callbackId) {
        if (!this.remoteStore.has(callbackId)) {
          this.remoteStore.add(callbackId, __bind(function() {
            var args;
            args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
            return this.handleResponse(callbackId, args);
          }, this));
        }
        return this.remoteStore.get(callbackId);
      }, this));
  ...
  Bongo.prototype.connect = function(callback) {
    ...
    return this.channel.once('broker:subscription_succeeded', __bind(function() {
      ...
      setTimeout(__bind(function() {
        return this.channel.emit('client-join', 'whats really happening');
      }, this), 1000);
  ...
  Bongo.prototype.getTimeout = function(message, timeout) {
    if (timeout == null) {
      timeout = 5000;
    }
    return setTimeout(this.messageFailed.bind(this, message), timeout);
  };
  Bongo.prototype.send = function(method, args) {
    ...
    if (!this.channel) {
      ...
      return scrubber.scrub(args, __bind(function() {
        ...
        message.timeout = this.getTimeout(message);
