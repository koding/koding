...
(function() {
  ...
  module.exports = Model = (function() {
    ...
    Model.on = (function() {
      ...
      return function(event, listener) {
        ...
        if (this.prototype.mq != null) {
          ...
          return channel.bind(event, __bind(function() {
            return this.wrapArgs([].slice.call(arguments), function(args) {
    ...
    Model.prototype.update_ = function(data) {
      ...
      Object.keys(fields).forEach(__bind(function(field) {
        var _ref;
        return (_ref = this.watchers[field]) != null ? _ref.forEach(__bind(function(watcher) {
          return watcher.call(this, fields[field]);
        }, this)) : void 0;
      }, this));
  ...
  module.exports = ModelLoader = (function() {
    ...
    load_ = function() {
      return this.constructor.one({
        ...
        return this.emit('load', err, model);
      }, this));
    };
      ...
      afterInit: (function() {
        ...
        return function() {
          ...
          if (broadcastable && (id != null)) {
            ...
            return this.channel.bind('updateInstance', __bind(function(data) {
              return this.update_(data);
            }, this));
          }
        };
      })(),
...
(function() {
  ...
  module.exports = {
    afterInit: function() {
      return typeof this.on === "function" ? this.on('updateInstance', __bind(function(data) {
        return this.updateInstances(data);
      }, this)) : void 0;
    },
    on: function(event, listener) {
      var multiplex;
...
bongo = (function() {
  var EventEmitter, JsPath, Model, ModelLoader, Traverse, api, clientId_, createConstructor, createId, dash, dnode, extend, findMyInstance, getModelLoader, instances_, loading_, race, sequence, slice, stack, updateInstances, wrapAll, wrapArgs, wrapFn, wrapInstanceMethods, wrapStaticMethods, _ref, _ref1;
  ...
  _ref1 = require('sinkrow'), bongo.daisy = _ref1.daisy, dash = _ref1.dash, bongo.dash = _ref1.dash, bongo.sequence = _ref1.sequence, bongo.race = _ref1.race, bongo.future = _ref1.future;
  ...
  findMyInstance = (function() {
    ...
    return function(data, extend) {
      ...
      data = !hasEncoder ? data : new Traverse(data).forEach(function(node) {
        ...
        } else if (this.path.length && !this.isLeaf && ((_ref2 = node.bongo_) != null ? _ref2.constructorName : void 0)) {
    ...
    return function(args, callback) {
      ...
      objectRefs.forEach(function(objectRef) {
        return objects.push(function() {
          var constructorName, id, _ref2;
          _ref2 = objectRef.node, constructorName = _ref2.constructorName, id = _ref2.id;
  ...
  bongo.connect = function(port, callback) {
    var client, _ref2;
    if (!callback) {
      _ref2 = [port, callback], callback = _ref2[0], port = _ref2[1];
    }
    client = dnode(api);
    client.stack = stack;
