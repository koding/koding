...
require.define("/node_modules/hat/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"index.js"}
});

require.define("/node_modules/hat/index.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/node_modules/koding-dnode/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"./index.js","browserify":"browser/index.js"}
});

require.define("/node_modules/koding-dnode/browser/index.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/node_modules/koding-dnode-protocol/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"index.js"}
});

require.define("/node_modules/koding-dnode-protocol/index.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/node_modules/jspath/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"index.js"}
});

require.define("/node_modules/jspath/index.js", function (require, module, exports, __dirname, __filename) {
(function() {
  var JsPath,
...
require.define("/node_modules/scrubber/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"index.js"}
});

require.define("/node_modules/scrubber/index.js", function (require, module, exports, __dirname, __filename) {
var Scrubber, Traverse, daisy;
...
module.exports = Scrubber = (function() {
  ...
  */
  Scrubber.prototype.scrub = function(obj, callback) {
    ...
    this.out = new Traverse(obj).map(function() {
      return steps.forEach(__bind(function(step) {
        return queue.push(__bind(function() {
          return step.call(scrubber, this, function() {
            return queue.next();
          });
        }, this));
      }, this));
  ...
  */
  ['forEach', 'indexOf', 'join', 'pop', 'reverse', 'shift', 'sort', 'splice', 'unshift', 'push'].forEach(__bind(function(method) {
...
require.define("/node_modules/socket.io-client/dist/browserify.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/src/model.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var Model;
  ...
  module.exports = Model = (function() {
    ...
    Model.prototype.mixin = Model.mixin = function(source) {
      ...
      for (key in source) {
        val = source[key];
        if (key !== 'constructor') _results.push(this[key] = val);
      }
      return _results;
    };
    ...
    Model.off = function(event, listener) {
      if (this.prototype.mq != null) {} else {
    ...
    Model.prototype.init = function(data) {
      ...
      if (!('instanceId' in model.bongo_)) model.bongo_.instanceId = createId();
      if ('_id' in model) bongo.addReferences(model);
    ...
    Model.prototype.setAt = function(path, value) {
      return JsPath.setAt(this.data, path, value);
    };
...
require.define("/node_modules/mongoop/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"index.js"}
});

require.define("/node_modules/mongoop/index.js", function (require, module, exports, __dirname, __filename) {
(function() {
  var MongoOp;
...
require.define("/src/jspath.coffee", function (require, module, exports, __dirname, __filename) {

  module.exports = require('jspath');

});

require.define("/src/eventmultiplexer.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  ...
  module.exports = EventMultiplexer = (function() {
    ...
    EventMultiplexer.prototype.on = function(event, listener) {
      ...
      if (isNew) return multiplex;
    };

    EventMultiplexer.prototype.off = function(event, listenerToRemove) {
      var index, listener, multiplex, multiplexer, _len, _ref;
      multiplexer = this;
      multiplex = multiplexer.events[event];
      if (!multiplex) {
        return -1;
        ...
        for (index = 0, _len = _ref.length; index < _len; index++) {
          listener = _ref[index];
          if (listener === listenerToRemove) multiplex.listeners.splice(index, 1);
        }
...
require.define("/src/util.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var __slice = Array.prototype.slice;
...
require.define("/src/modelloader.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  ...
  module.exports = ModelLoader = (function() {
    ...
    __extends(ModelLoader, EventEmitter);
...
require.define("/src/race.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var Race;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __slice = Array.prototype.slice;
...
require.define("/src/sequence.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var Sequence, slice;
  ...
  Sequence = (function() {
    ...
    Sequence.prototype.next = function(args) {
      ...
      if (this.times--) return this.fn.apply(this, args.concat(nextFn));
    };
...
require.define("/node_modules/sinkrow/package.json", function (require, module, exports, __dirname, __filename) {
module.exports = {"main":"lib/sinkrow/index.js"}
});

require.define("/node_modules/sinkrow/lib/sinkrow/index.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/node_modules/sinkrow/lib/sinkrow/sequence.js", function (require, module, exports, __dirname, __filename) {
var Sequence, slice;
Sequence = (function() {
  function Sequence(fn, cb) {
    this.fn = fn;
...
require.define("/node_modules/sinkrow/lib/sinkrow/race.js", function (require, module, exports, __dirname, __filename) {
var Race;
var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; }, __slice = Array.prototype.slice;
Race = (function() {
  function Race(fn, cb) {
...
require.define("/node_modules/sinkrow/lib/sinkrow/future.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/node_modules/sinkrow/lib/sinkrow/pipeline.js", function (require, module, exports, __dirname, __filename) {
...
require.define("/src/eventemitter/pusher.coffee", function (require, module, exports, __dirname, __filename) {
  ...
  module.exports = (function() {
    ...
    return {
      afterInit: (function() {
        ...
        return function() {
          ...
          if (broadcastable && (id != null)) {
            name = "object-" + id;
            this.channel = channels[name] || (channels[name] = this.mq.subscribe(name));
      ...
      on: function(event, listener) {
        ...
        if (multiplex) return this.channel.bind(event, multiplex);
      },
...
require.define("/src/eventemitter/dnode.coffee", function (require, module, exports, __dirname, __filename) {

  module.exports = {
    afterInit: function() {
      var _this = this;
      console.log('this is the cuplrit');
      return typeof this.on === "function" ? this.on('updateInstance', function(data) {
...
require.define("/bongo.js", function (require, module, exports, __dirname, __filename) {
    /*
Bongo.js
...
bongo = (function() {
  var EventEmitter, JsPath, Model, ModelLoader, Traverse, api, clientId_, createConstructor, createId, dash, dnode, extend, findMyInstance, getModelLoader, instances_, loading_, race, sequence, slice, stack, updateInstances, wrapAll, wrapArgs, wrapFn, wrapInstanceMethods, wrapStaticMethods, _ref, _ref2;
  ...
  race = bongo.race = require('./src/race');

  sequence = bongo.sequence = require('./src/sequence');

  slice = [].slice;

  _ref = require('./src/util'), extend = _ref.extend, bongo.asynchronizeOwnMethods = _ref.asynchronizeOwnMethods;

  _ref2 = require('sinkrow'), bongo.daisy = _ref2.daisy, dash = _ref2.dash, bongo.dash = _ref2.dash, bongo.sequence = _ref2.sequence, bongo.race = _ref2.race, bongo.future = _ref2.future;
  ...
  bongo.cacheable = (function() {
    ...
    handleBatch = function(batch, callback) {
      var collectItems, item, models, _i, _len;
      models = [];
      collectItems = race(function(i, single, fin) {
  ...
  findMyInstance = (function() {
    ...
    return function(data, extend) {
      ...
      data = !hasEncoder ? data : new Traverse(data).forEach(function(node) {
        if ('string' === typeof node) return this.update(Encoder.htmlEncode(node));
      });
  ...
  wrapStaticMethods = (function() {
    ...
    return function(constructor, staticMethods) {
      ...
      _fn = function(methodName, method) {
        if (__indexOf.call(optimizeThese, methodName) >= 0) methodName += '_';
  ...
  wrapAll = function(obj) {
    new Traverse(obj).forEach(function(node) {
      if ('function' === typeof node) return this.update(wrapFn(node));
    });
  };
  ...
  wrapArgs = (function() {
    ...
    return function(args, callback) {
      ...
      if (!objectRefs.length) return callback(args);
      objects = [];
  ...
  bongo.connect = function(port, callback) {
    var client, _ref3;
    if (!callback) _ref3 = [port, callback], callback = _ref3[0], port = _ref3[1];
    client = dnode(api);
    client.stack = stack;
...
if (!isBrowser && module) {
  ...
  if (typeof window !== "undefined" && window !== null) window.bongo = bongo;
}
