...
require.define("/node_modules/bongo-client/src/listenertree.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  'use strict';
...
require.define("/node_modules/bongo-client/src/eventbus.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  'use strict';
...
require.define("/node_modules/bongo-client/bongo.js",function(require,module,exports,__dirname,__filename,process){'use strict';
...
Bongo = (function(_super) {
  var EventBus, JsPath, Model, Scrubber, Store, Traverse, createBongoName, createId, dash, extend, race, sequence, slice, _ref, _ref1, _ref2;
  ...
  Bongo.prototype.connect = function(callback) {
    ...
    return this.channel.once('broker:bind_succeeded', function() {
      ...
      if (!_this.readyState) {
        console.log('state is frakin ready');
        setTimeout(function() {
