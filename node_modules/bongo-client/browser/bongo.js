...
require.define("/src/channel.coffee", function (require, module, exports, __dirname, __filename) {
(function() {
  var Channel;
  ...
  module.exports = Channel = (function() {
    ...
    function Channel(channel) {
      ...
      for (method in channel) {
        fn = channel[method];
        if ('function' === typeof fn) this[method] = fn.bind(channel);
      }
      this.on = this.bind;
...
bongo = (function() {
  ...
  getCancellableCallback_ = function(callback) {
    ...
    kallback = function() {
      var rest;
      rest = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (!cancelled) return callback.apply(null, rest);
    };
  ...
  bongo.connect = function(port, callback) {
    var client, _ref4;
    if (!callback) _ref4 = [port, callback], callback = _ref4[0], port = _ref4[1];
    client = dnode(api);
    client.stack = stack;
