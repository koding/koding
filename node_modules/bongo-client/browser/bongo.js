...
require.define("/node_modules/bongo-client/src/eventbus.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = EventBus = (function() {
    ...
    function EventBus(mq) {
      ...
      this.channel.on('broker:subscription_succeeded', function() {
        console.log('subscription succeeded.');
        return _this.channel.on('#', _this.dispatch.bind(_this));
      });
    }

    EventBus.prototype.dispatch = function(payload, routingKey) {
      console.log(routingKey, '<-- EventBus');
...
Bongo = (function(_super) {
  ...
  Bongo.prototype.registerInstance = function(inst) {
    ...
    return inst.on('listenerRemoved', function(event, listener) {
