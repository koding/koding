...
require.define("/node_modules/bongo-client/node_modules/browserify/node_modules/vm-browserify/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index.js"}});

require.define("/node_modules/bongo-client/node_modules/browserify/node_modules/vm-browserify/index.js",function(require,module,exports,__dirname,__filename,process){var Object_keys = function (obj) {
...
require.define("/node_modules/koding-dnode/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"./index.js","browserify":"browser/index.js"}});

require.define("/node_modules/koding-dnode/browser/index.js",function(require,module,exports,__dirname,__filename,process){var protocol = require('koding-dnode-protocol');
...
require.define("/node_modules/scrubber/index.js",function(require,module,exports,__dirname,__filename,process){var Scrubber, Traverse, daisy, global;
...
require.define("/node_modules/koding-dnode/node_modules/socket.io-client/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"./lib/io.js","browserify":"./dist/browserify.js"}});

require.define("/node_modules/koding-dnode/node_modules/socket.io-client/dist/browserify.js",function(require,module,exports,__dirname,__filename,process){(function () {var io = module.exports;/*! Socket.IO.js build:0.8.6, development. Copyright(c) 2011 LearnBoost <dev@learnboost.com> MIT Licensed */
...
require.define("/node_modules/koding-dnode/node_modules/jsonify/package.json",function(require,module,exports,__dirname,__filename,process){module.exports = {"main":"index.js"}});

require.define("/node_modules/koding-dnode/node_modules/jsonify/index.js",function(require,module,exports,__dirname,__filename,process){exports.parse = require('./lib/parse');
exports.stringify = require('./lib/stringify');
});

require.define("/node_modules/koding-dnode/node_modules/jsonify/lib/parse.js",function(require,module,exports,__dirname,__filename,process){var at, // The index of the current character
    ch, // The current character
    escapee = {
        '"':  '"',
        '\\': '\\',
...
require.define("/node_modules/koding-dnode/node_modules/jsonify/lib/stringify.js",function(require,module,exports,__dirname,__filename,process){var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
    escapable = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
    gap,
    indent,
    meta = {    // table of character substitutions
...
require.define("/node_modules/bongo-client/src/jspath.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
  ...
  module.exports = (function() {
    ...
    return {
      afterInit: (function() {
        ...
        return function() {
          ...
          if (broadcastable && (id != null)) {
            ...
            return this.channel.on('updateInstance', function(data) {
      ...
      on: function(event, listener) {
        ...
        return this.channel.on(event, function(_arg) {
          var data;
          data = _arg.data;
          return constructor.wrapArgs([data], function(args) {
            return listener.call.apply(listener, [_this].concat(__slice.call(args)));
          });
        });
      },
...
require.define("/node_modules/bongo-client/src/eventemitter/dnode.coffee",function(require,module,exports,__dirname,__filename,process){(function() {
    ...
    return function(constructor, staticMethods) {
      ...
      _fn = function(methodName, method) {
        ...
        constructor[methodName] = function(err, res) {
          ...
          if (method.useMQ) {
            channelId = createId();
            console.log("Static channel " + channelId);
      ...
      _fn = function(methodName, method) {
        ...
        constructor.prototype[methodName] = function() {
          ...
          if (method.useMQ) {
            ...
            console.log("instance channel " + channelId);
            channel = bongo.mq.subscribe(channelId);
            channel.on('broker:subscription_succeeded', function() {
