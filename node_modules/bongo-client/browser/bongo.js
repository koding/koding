...
*/
Bongo = (function() {
  var EventEmitter, JsPath, Model, ModelLoader, Scrubber, Store, Traverse, createBongoName, createId, createRemoteApiShims, dash, dnode, extend, race, sequence, slice, _ref, _ref2, _ref3, _ref4;
  EventEmitter = require('events').EventEmitter;
  Traverse = require('traverse');
  ...
  slice = [].slice;
  _ref2 = require('./src/util'), extend = _ref2.extend, Bongo.asynchronizeOwnMethods = _ref2.asynchronizeOwnMethods;
  _ref3 = require('sinkrow'), race = _ref3.race, sequence = _ref3.sequence, dash = _ref3.dash;
  _ref4 = require('sinkrow'), Bongo.daisy = _ref4.daisy, Bongo.dash = _ref4.dash, Bongo.sequence = _ref4.sequence, Bongo.race = _ref4.race, Bongo.future = _ref4.future;
