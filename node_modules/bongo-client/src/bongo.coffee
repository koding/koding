...
class Bongo extends EventEmitter
  ...
  registerInstance:(inst)->
     # using defineProperty here to avoid a rather nasty bug when the server
     # sends an "_events" property that clobbers this one.
    Object.defineProperty inst, '_events', value: {}
  ...
  connect:(callback)->
    console.log 'conneck is kalled', @channelName
