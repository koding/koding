...
class Bongo
  ...
  createRemoteApiShims =(api)->
    for name, methods of api
      console.log 'constructor',      name
      console.log 'static methods',   methods.statik if methods.statik?.length
      console.log 'instance methods', methods.instance if methods.instance?.length
  ...
  send:(method, args)->
    ...
    unless @channel
      ...
      scrubber.scrub args, =>
        ...
        @channel.emit 'client-message', JSON.stringify(message)

  disconnect:(callback)->

  fetchApi:(callback)->
    @send 'fetchApi', (err, api)=>
