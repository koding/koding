...
Bongo = (function(_super) {
  ...
  function Bongo(options) {
    ...
    this.readyState = 0;
    this.stack = [];
    this.mq.on('connected', console.log.bind(console, 'Connected event:'));
    this.mq.on('disconnected', console.log.bind(console, 'Disconnected event:'));
  ...
  Bongo.prototype.defineApi = function(api) {
    console.log('defineApi is called');
