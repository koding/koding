...
app.get  '/-/oauth/github/callback'              , csrf,   require './github_callback'
app.get  '/-/oauth/facebook/callback'            , csrf,   require './facebook_callback'
app.get  '/-/oauth/google/callback'              , csrf,   require './google_callback'
app.get  '/-/oauth/linkedin/callback'            , require './linkedin_callback'
app.get  '/-/oauth/twitter/callback'             , require './twitter_callback'
app.post '/:name?/OAuth'                         , csrf,   require './oauth'
