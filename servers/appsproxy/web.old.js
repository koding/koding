...
app.use(function (req, res, next) {
    ...
    if (req.headers.origin === "http://lvh.me:3020"){ allow = "http://lvh.me:3020"; }
    if (req.headers.origin === "http://localhost:3020"){ allow = "http://localhost:3020"; }
    if (req.headers.origin === "https://latest.koding.com/*"){ allow = "https://latest.koding.com/*"; }
    if (req.headers.origin === "https://koding.com/*"){ allow = "https://koding.com/*"; }
